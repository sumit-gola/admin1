...
@section('content')
            ...
            <div class="swiper navigation-swiper rounded swiper-initialized swiper-horizontal swiper-backface-hidden">
                <div class="swiper-wrapper" id="swiper-wrapper-cc13fca50846ff8d" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-700px, 0px, 0px); transition-delay: 0ms;">
                    
                    
                    
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3" data-swiper-slide-index="1" style="width: 350px;">
                        <img src="assets/images/small/img-5.jpg" alt="" class="img-fluid">
                    </div><div class="swiper-slide swiper-slide-prev" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="width: 350px;">
                        <img src="assets/images/small/img-6.jpg" alt="" class="img-fluid">
                    </div><div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 3" data-swiper-slide-index="0" style="width: 350px;">
                        <img src="assets/images/small/img-4.jpg" alt="" class="img-fluid">
                    </div></div>
                <div class="swiper-button-next material-shadow" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-cc13fca50846ff8d"></div>
                <div class="swiper-button-prev material-shadow" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-cc13fca50846ff8d"></div>
